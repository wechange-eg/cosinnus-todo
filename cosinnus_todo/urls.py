...
cosinnus_group_patterns = patterns('cosinnus_todo.views',
    ...
    url(r'^list/(?P<tag>[^/]+)/$', 'entry_list_view', name='list-filtered'),
    ...
    url(r'^todolist/(?P<listslug>[^/]+)/$', 'entry_list_view', name='todolist-detail'),
    url(r'^todolist/(?P<listslug>[^/]+)/(?P<tag>[^/]+)/$', 'entry_list_view', name='todolist-detail-filtered'),
