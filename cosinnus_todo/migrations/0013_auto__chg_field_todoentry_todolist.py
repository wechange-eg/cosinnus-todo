...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TodoEntry.todolist'
        db.alter_column(u'cosinnus_todo_todoentry', 'todolist_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cosinnus_todo.TodoList']))

    def backwards(self, orm):

        # Changing field 'TodoEntry.todolist'
        db.alter_column(u'cosinnus_todo_todoentry', 'todolist_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['cosinnus_todo.TodoList'], null=True))
