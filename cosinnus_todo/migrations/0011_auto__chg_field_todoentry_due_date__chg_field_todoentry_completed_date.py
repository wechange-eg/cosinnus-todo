...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TodoEntry.due_date'
        db.alter_column(u'cosinnus_todo_todoentry', 'due_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'TodoEntry.completed_date'
        db.alter_column(u'cosinnus_todo_todoentry', 'completed_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'TodoEntry.due_date'
        db.alter_column(u'cosinnus_todo_todoentry', 'due_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'TodoEntry.completed_date'
        db.alter_column(u'cosinnus_todo_todoentry', 'completed_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
