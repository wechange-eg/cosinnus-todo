...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TodoEntry.is_completed'
        db.add_column(u'todo_todoentry', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TodoEntry.is_completed'
        db.delete_column(u'todo_todoentry', 'is_completed')
    ...
    models = {
        ...
        u'todo.todoentry': {
            'Meta': {'ordering': "['is_completed', '-completed_date', '-priority', '-due_date']", 'object_name': 'TodoEntry'},
