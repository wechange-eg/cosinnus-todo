...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cosinnus_todo_todolist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=55, blank=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'+', on_delete=models.PROTECT, to=orm['cosinnus.CosinnusGroup'])),
        ))
        db.send_create_signal(u'cosinnus_todo', ['TodoList'])

        # Adding unique constraint on 'TodoList', fields ['group', 'slug']
        db.create_unique(u'cosinnus_todo_todolist', ['group_id', 'slug'])

        # Adding field 'TodoEntry.todolist'
        db.add_column(u'cosinnus_todo_todoentry', 'todolist',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'todos', on_delete=models.PROTECT, default=None, to=orm['cosinnus_todo.TodoList'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'TodoList', fields ['group', 'slug']
        db.delete_unique(u'cosinnus_todo_todolist', ['group_id', 'slug'])

        # Deleting model 'TodoList'
        db.delete_table(u'cosinnus_todo_todolist')

        # Deleting field 'TodoEntry.todolist'
        db.delete_column(u'cosinnus_todo_todoentry', 'todolist_id')
    ...
    models = {
        ...
        u'cosinnus_todo.todoentry': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_todo_todoentry_set'", 'on_delete': 'models.PROTECT', 'to': u"orm['cosinnus.CosinnusGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'cosinnus_todo.todolist': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'on_delete': 'models.PROTECT', 'to': u"orm['cosinnus.CosinnusGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '55', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
