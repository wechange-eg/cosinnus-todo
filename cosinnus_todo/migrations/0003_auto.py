...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field attached_objects on 'TodoEntry'
        m2m_table_name = db.shorten_name(u'cosinnus_todo_todoentry_attached_objects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('todoentry', models.ForeignKey(orm[u'cosinnus_todo.todoentry'], null=False)),
            ('attachedobject', models.ForeignKey(orm[u'cosinnus.attachedobject'], null=False))
        ))
        db.create_unique(m2m_table_name, ['todoentry_id', 'attachedobject_id'])


    def backwards(self, orm):
        # Removing M2M table for field attached_objects on 'TodoEntry'
        db.delete_table(db.shorten_name(u'cosinnus_todo_todoentry_attached_objects'))
