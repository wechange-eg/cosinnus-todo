...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TodoEntry.creator'
        db.add_column(u'cosinnus_todo_todoentry', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'cosinnus_todo_todoentry_set', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TodoEntry.created'
        db.add_column(u'cosinnus_todo_todoentry', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TodoEntry.creator'
        db.delete_column(u'cosinnus_todo_todoentry', 'creator_id')

        # Deleting field 'TodoEntry.created'
        db.delete_column(u'cosinnus_todo_todoentry', 'created')
