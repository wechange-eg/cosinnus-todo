...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TodoEntry.group'
        db.alter_column(u'cosinnus_todo_todoentry', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cosinnus.CosinnusGroup']))

        # Changing field 'TodoEntry.media_tag'
        db.alter_column(u'cosinnus_todo_todoentry', 'media_tag_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cosinnus.TagObject'], unique=True, null=True, on_delete=models.SET_NULL))

        # Changing field 'TodoList.group'
        db.alter_column(u'cosinnus_todo_todolist', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cosinnus.CosinnusGroup']))

    def backwards(self, orm):

        # Changing field 'TodoEntry.group'
        db.alter_column(u'cosinnus_todo_todoentry', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['cosinnus.CosinnusGroup']))

        # Changing field 'TodoEntry.media_tag'
        db.alter_column(u'cosinnus_todo_todoentry', 'media_tag_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cosinnus.TagObject'], unique=True, null=True, on_delete=models.PROTECT))

        # Changing field 'TodoList.group'
        db.alter_column(u'cosinnus_todo_todolist', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['cosinnus.CosinnusGroup']))
    ...
    models = {
        ...
        u'cosinnus_todo.todoentry': {
            ...
            'completed_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_todo_todoentry_set'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['auth.User']"}),
            'due_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'cosinnus_todo_todoentry_set'", 'to': u"orm['cosinnus.CosinnusGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'todolist': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'todos'", 'on_delete': 'models.PROTECT', 'default': 'None', 'to': u"orm['cosinnus_todo.TodoList']", 'blank': 'True', 'null': 'True'})
        },
        u'cosinnus_todo.todolist': {
            'Meta': {'ordering': "(u'title',)", 'unique_together': "((u'group', u'slug'),)", 'object_name': 'TodoList'},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'to': u"orm['cosinnus.CosinnusGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '55', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
