...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cosinnus_todo_comment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'todo_comments', on_delete=models.PROTECT, to=orm['auth.User'])),
            ...
            ('todo', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'comments', to=orm['cosinnus_todo.TodoEntry'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'cosinnus_todo', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table(u'cosinnus_todo_comment')
    ...
    models = {
        ...
        u'cosinnus_todo.comment': {
            'Meta': {'ordering': "[u'created_on']", 'object_name': 'Comment'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'todo_comments'", 'on_delete': 'models.PROTECT', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'todo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'comments'", 'to': u"orm['cosinnus_todo.TodoEntry']"})
        },
        u'cosinnus_todo.todoentry': {
            ...
            'todolist': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'todos'", 'null': 'True', 'blank': 'True', 'to': u"orm['cosinnus_todo.TodoList']"})
        },
