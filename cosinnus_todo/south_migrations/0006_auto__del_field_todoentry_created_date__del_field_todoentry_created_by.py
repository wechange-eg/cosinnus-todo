...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TodoEntry.created_date'
        db.delete_column(u'cosinnus_todo_todoentry', 'created_date')

        # Deleting field 'TodoEntry.created_by'
        db.delete_column(u'cosinnus_todo_todoentry', 'created_by_id')


    def backwards(self, orm):
        # Adding field 'TodoEntry.created_date'
        db.add_column(u'cosinnus_todo_todoentry', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'TodoEntry.created_by'
        # get any valid user id, will be overwritten by 0004 migration anyway
        valid_user_id = orm['auth.User'].objects.all()[0].id
        db.add_column(u'cosinnus_todo_todoentry', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=valid_user_id, related_name=u'todos', on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)
